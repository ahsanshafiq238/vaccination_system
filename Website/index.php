              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    ...
                    <p>
                    We have all latest vaccines for all age groups. The Vaccination Center operates daily with no need for prior appointment. It is equipped with all important vaccines and well-trained vaccinator to ensure that appropriate vaccinations are administered in alignment with the approved protocol.                     </p>
                    <div class="btn-box">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
            We are renowned & recognized laboratory not just in Pakistan as well as internationally. Our focus is on providing dependable 
            and reliable Clinical Laboratory and Diagnostic Services. Dr Essa Laboratory has a large laboratory network of outlets 
            nationwide and has received many/multiple Consumer Choice Awards honoring our dedication, credibility, quality of service and
            professionalism.
            </p>
    ...
    <div class="container">
      <div class="heading_container heading_center">
        ...
        <p class="col-md-10 mx-auto px-0">
          Our hospitals are equipped with all important vaccines and well-trained vaccinators to ensure that appropriate vaccinations are
          administered in alignment with the approved protocols.        
        </p>
      </div>
      <div class="row">
        <?php 
  ...
  <footer class="footer_section">
    <div class="container">
      ...
      <div class="footer-info">
        <p>
          &copy; <span id="displayYear"></span> All Rights Reserved By Ahsan Shafiq, Daniyal Farooq and Hammad Yousuf
        </p>
      </div>
    </div>
  </footer>
